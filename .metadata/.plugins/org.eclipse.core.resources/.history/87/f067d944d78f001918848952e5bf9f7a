...
//Numero de cama
	...
	public DlgCama() {
		...
		setBounds(300, 100, 527, 459);
		getContentPane().setLayout(null);

		btnIngresar = new JButton("+");
		btnIngresar.addActionListener(this);
		btnIngresar.setBounds(391, 8, 46, 25);
		getContentPane().add(btnIngresar);

		btnModificar = new JButton("");
		btnModificar.setIcon(new ImageIcon("G:\\AED\\sdfsd\\Soluci\u00F3n_Proyectos_IA\\Proyecto_\\src\\img\\modificar.png"));
		btnModificar.addActionListener(this);
		btnModificar.setBounds(295, 84, 46, 23);
		getContentPane().add(btnModificar);

		btnEliminar = new JButton("");
		btnEliminar.setIcon(new ImageIcon("G:\\AED\\sdfsd\\Soluci\u00F3n_Proyectos_IA\\Proyecto_\\src\\img\\eliminar.png"));
		btnEliminar.addActionListener(this);
		btnEliminar.setBounds(337, 84, 36, 23);
		getContentPane().add(btnEliminar);

		btnCerrar = new JButton("");
		btnCerrar.setIcon(new ImageIcon("G:\\AED\\sdfsd\\Soluci\u00F3n_Proyectos_IA\\Proyecto_\\src\\img\\logout.jpg"));
		btnCerrar.addActionListener(this);
		btnCerrar.setBounds(371, 84, 36, 23);
		getContentPane().add(btnCerrar);

		scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 137, 489, 276);
		...
		btnVerTodoslistar.setBounds(416, 84, 85, 23);
